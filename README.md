...
{R/R00}_{t+1} &= \alpha  S_{t+1}  \mathbb{E}\left[(p(v_t)-y) \cdot (p(v_t)-y)^T\right]  S_{t+1}
\end{align}



where $v_t = \text{prox}(g_t + yS_t; S_t)$ for $g_t,g_0\sim N(0,R_t)$ and $y\sim \bold{p}(g_0)$
